...
namespace EasyITCenter.Controllers {
    ...
    public class WebGlobalGetInfoTablesApi : ControllerBase {
        ...
        [HttpGet("/WebApi/WebPages/WebToolList/{webOnly}")]
        public async Task<string> GetWebToolList(bool webOnly = false) {
            try {
                ...
                using (new TransactionScope(TransactionScopeOption.Required, new TransactionOptions {
                    ...
                    if (webOnly) {
                        data = new EasyITCenterContext().ServerToolPanelDefinitionLists.Include(a => a.ToolType).Where(a => a.ToolType.Id == 11 || a.ToolType.Id == 1006 || a.ToolType.Id == 1009).OrderBy(a => a.ToolType.Sequence).ToList();
                    }
                    else { data = new EasyITCenterContext().ServerToolPanelDefinitionLists.Include(a => a.ToolType).OrderBy(a => a.ToolType.Sequence).ToList(); }
                }
        ...
        [HttpGet("/WebApi/WebPages/WebCodeLibraryList")]
