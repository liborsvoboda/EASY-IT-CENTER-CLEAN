namespace EASYDATACenter.Controllers {
    ...
    [ApiController]
    [Route("OfferList")]
    public class OfferListApi : ControllerBase {
        ...
        [HttpGet("/OfferList/Filter/{filter}")]
        ...
        public async Task<string> InsertOfferList([FromBody] OfferList record) {
            try {
                ...
                documentAdvice = new EASYDATACenterContext().DocumentAdviceLists.Where(a => a.DocumentType == "offer" && (a.StartDate == null || a.StartDate <= DateTime.UtcNow.Date) && (a.EndDate == null || a.EndDate >= DateTime.UtcNow.Date)).FirstOrDefault();
