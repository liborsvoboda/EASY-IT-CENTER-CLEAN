namespace EasyITCenter.ServerCoreStructure {
    ...
    /// </summary>
    public class EasyITCenterContextExtension : IHttpContextAccessor {
        ...
        public static bool IsServerRequest() {
            try {
                ...
                string? clientIpAddress = Dns.GetHostEntry(context?.Connection.RemoteIpAddress).AddressList.First(x => x.AddressFamily == System.Net.Sockets.AddressFamily.InterNetwork).ToString();                
                return clientIpAddress != null && clientIpAddress == "127.0.0.1" ? true : false;
            } catch { return false; }
        }
