...
var loading = (0, get_loading_markup_1.default)();
...
var getCdnMarkup = function (_a) {
    ...
    var buildCDNUrl = function (packageName, suffix) { return filter("".concat(cdnUrl, "/").concat(packageName).concat(version ? "@".concat(version) : '', "/").concat(suffix) || ''); };
    return "\n    <link \n      rel=\"stylesheet\" \n      href=\"".concat(buildCDNUrl('graphql-playground-react', 'build/static/css/index.css'), "\"\n    />\n    ").concat(typeof faviconUrl === 'string' ? "<link rel=\"shortcut icon\" href=\"".concat(filter(faviconUrl || ''), "\" />") : '', "\n    ").concat(faviconUrl === undefined ? "<link rel=\"shortcut icon\" href=\"".concat(buildCDNUrl('graphql-playground-react', 'build/favicon.png'), "\" />") : '', "\n    <script \n      src=\"").concat(buildCDNUrl('graphql-playground-react', 'build/static/js/middleware.js'), "\"\n    ></script>\n");
};
var renderConfig = function (config) {
    return (0, xss_1.filterXSS)("<div id=\"".concat(CONFIG_ID, "\">").concat(JSON.stringify(config), "</div>"), {
        whiteList: { div: ['id'] },
    });
};
